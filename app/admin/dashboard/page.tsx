        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden">
          <table className="w-full text-left text-sm text-gray-400">
            <thead className="bg-gray-800 text-gray-200 font-bold">
              <tr><th className="p-4">封面</th><th className="p-4">标题/作者</th><th className="p-4">分类</th><th className="p-4">数据/热门</th><th className="p-4 text-right">操作</th></tr>
            </thead>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select value={formData.category} onChange={e=>setFormData({...formData, category: e.target.value})} className="w-full bg-black border border-gray-700 rounded p-2">
                      <option>动画短片</option><option>实验短片</option><option>音乐MV</option><option>写实短片</option><option>创意广告</option><option>AI教程</option><option>创意短片</option>
                    </select>
                  </div>
